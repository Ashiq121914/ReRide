...
import img from "../../../assets/2DYSWHK.jpg";
  ...
  return (
    <div className="relative flex flex-col-reverse py-16 lg:py-0 lg:flex-col w-4/5 mx-auto shadow-xl shadow-blue-500/50 mt-56">
      <div className="w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:py-20 lg:max-w-screen-xl">
        <div className="mb-0 lg:max-w-lg lg:pr-8 xl:pr-6">
          ...
          <div className="flex flex-col items-center">
            <div className="mb-2 text-sm text-white  md:mb-2">Follow us</div>
      ...
      <div className="inset-y-0 top-0 right-0 w-full max-w-xl px-4 mx-auto mb-6 md:px-0 lg:pl-8 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-1/2 lg:max-w-full lg:absolute xl:px-0">
        <img
          className="object-cover w-full h-56 rounded shadow-lg lg:rounded-none lg:shadow-none md:h-96 lg:h-full shadow-xl"
          src={img}
          alt=""
        />
      </div>
